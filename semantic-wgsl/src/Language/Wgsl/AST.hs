-- Language definition for Wgsl, generated by ast-generate. Do not edit!
{-# LANGUAGE CPP #-}
{-# LANGUAGE DataKinds #-}
...
module Language.Wgsl.AST (module Language.Wgsl.AST, getTestCorpusDir) where
...
import TreeSitter.Wgsl (getTestCorpusDir)
